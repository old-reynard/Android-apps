...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    */
    ...
    private void savePet() {
        ...
        if (TextUtils.isEmpty(nameValue) && TextUtils.isEmpty(breedValue) && TextUtils.isEmpty(weightString) && mGender == PetEntry.GENDER_UNKNOWN) {
            return;
        }
        ...
        values.put(PetEntry.COLUMN_PET_NAME, nameValue);
        values.put(PetEntry.COLUMN_PET_BREED, breedValue);
